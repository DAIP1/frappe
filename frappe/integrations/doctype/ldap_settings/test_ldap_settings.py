...
class LDAP_TestCase:
	...
	def test_sync_roles(self):
		...
		role_to_group_map = {
			self.doc["ldap_groups"][0]["draerp_role"]: self.doc["ldap_groups"][0]["ldap_group"],
			self.doc["ldap_groups"][1]["draerp_role"]: self.doc["ldap_groups"][1]["ldap_group"],
			self.doc["ldap_groups"][2]["draerp_role"]: self.doc["ldap_groups"][2]["ldap_group"],
	...
	DOCUMENT_GROUP_MAPPINGS = [
		{
			...
			"draerp_role": "System Manager",
		},
		{"doctype": "LDAP Group Mapping", "ldap_group": "Users", "draerp_role": "Blogger"},
		{"doctype": "LDAP Group Mapping", "ldap_group": "Group3", "draerp_role": "Accounts User"},
	]
...
class Test_ActiveDirectory(LDAP_TestCase, TestCase):
	...
	DOCUMENT_GROUP_MAPPINGS = [
		...
		{"doctype": "LDAP Group Mapping", "ldap_group": "Domain Users", "draerp_role": "Blogger"},
		{
			"doctype": "LDAP Group Mapping",
			"ldap_group": "Enterprise Administrators",
			"draerp_role": "Accounts User",
		},
	]
