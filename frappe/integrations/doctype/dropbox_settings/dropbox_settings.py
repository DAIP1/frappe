...
def get_dropbox_settings(redirect_uri=False):
	if not frappe.conf.dropbox_broker_site:
		frappe.conf.dropbox_broker_site = "https://dropbox.draerp.com"
		...
		app_details.update(
			{
				...
				+ "/api/method/dropbox_draerp_broker.www.setup_dropbox.generate_dropbox_access_token",
			}
		)
...
def get_redirect_url():
	if not frappe.conf.dropbox_broker_site:
		frappe.conf.dropbox_broker_site = "https://dropbox.draerp.com"
	url = "{}/api/method/dropbox_draerp_broker.www.setup_dropbox.get_authotize_url".format(
